...
def drawLsystem(instructions,d_1,d_2,d_3,a_1,a_2):                        # definiert die Funktion 'drawLsystem' welche alle Informationen für das Visualisieren des L-Systems enthält 
